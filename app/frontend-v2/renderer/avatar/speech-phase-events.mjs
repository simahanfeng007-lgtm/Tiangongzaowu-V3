...
//         detail: { phase: "start" | "energy" | "stop", energy?, at: <单调时钟> },
//       }))
...
// phase 非法返回 false（不 dispatch）；detail 只含 phase/(energy)/at 三键。
export function dispatchSpeechPhase(phase, { energy = null, target = null, nowMonotonic = null } = {}) {
