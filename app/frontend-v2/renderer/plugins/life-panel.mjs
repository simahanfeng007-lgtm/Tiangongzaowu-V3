...
const SETTING_FIELDS = [
  ...
  { key: "llm_daily_budget", label: "每日模型成功预算", type: "number", min: 0, max: 1000, step: 1, help: "自主生命活动每天最多成功调用模型的次数；0 表示当天完全禁止模型调用。" },
  { key: "llm_daily_attempt_budget", label: "每日模型尝试预算", type: "number", min: 0, max: 2000, step: 1, help: "包括成功、失败和超时；0 表示当天完全禁止模型调用。" },
