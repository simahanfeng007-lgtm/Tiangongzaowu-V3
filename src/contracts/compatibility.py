...
# P19-R2 M3.1 起 WriteEvidenceV2 加入合同包后的当前阶段 digest。
P19_R2_M3_VERIFICATION_SCHEMA_BASELINE_SHA256 = (
    "5d5bde6e776c2d018136394a3fe53e7eaddd69f6dc12068e518dcb8fec16d310"
)
# P19-R2 M4 起 Plan/Readiness/Closeout 契约加入后的阶段 digest。
P19_R2_M4_VERIFICATION_SCHEMA_BASELINE_SHA256 = (
    "e0aafee8f2deaabbfd307902903a7fa23a2d12cf4e679b620fee6da8ebeb7478"
)
# P19-R2 M4.1 起 PlanEntryV2（嵌套完整 AcceptancePredicate）替代 v1 后的
# 当前阶段 digest（Plan schema_version 同步升级 v2）。
P19_R2_M41_VERIFICATION_SCHEMA_BASELINE_SHA256 = (
    "ac70a282264435f512037ad02dd77f77fcb1ea35ddd30086c407460ad779c6af"
)
# P7C.1 adds the signed CompositionExecutionBindingV1 root plus optional,
# all-or-none binding fields on Intent, Decision, Ticket, and Grant.
P7C1_COMPOSITION_EXECUTION_SCHEMA_BASELINE_SHA256 = (
    "afe67da31231306950ea2437ed47694c61be84ed8b071615901200a44a9a1e58"
)
# P7D.2 extends the signed CompositionExecutionBindingV1 with optional,
# all-or-none current-epoch continuation and predecessor coordinates.
P7D2_COMPOSITION_EXECUTION_SCHEMA_BASELINE_SHA256 = (
    "39b15ea6c5ab6403c8b135b9db7f5f6c4abc9bf919426aa1405892511d77647b"
)
# S5/S6 add an optional, paired fixed execution-profile identity to the
# signed binding. Legacy wire shapes omit both fields and keep their hashes.
CONTROLLED_COMPOSITION_PROFILE_SCHEMA_BASELINE_SHA256 = (
    "d74baca08688d2b975e33deb9ac6d0297f90ef97e56d4d7c280cae3e881de4a0"
)
# Additive task intent and optional SkillCandidate metadata; empty extensions
# preserve the serialized bytes of previously persisted requests/selections.
DICTIONARY_TASK_CONTEXT_SCHEMA_BASELINE_SHA256 = (
    "12831564fc110e233e77e9ee6b52bef0b91d2d6539eff735da4f1ddf3751e148"
)
REVIEWED_SCHEMA_BASELINE_SHA256 = DICTIONARY_TASK_CONTEXT_SCHEMA_BASELINE_SHA256
