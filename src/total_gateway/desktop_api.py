...
_ROUTES = (
    ...
    _route("POST", "/api/v1/v3/life/capability/outcome", "life"),
    _route("POST", "/api/v1/v3/life/capability/reactivate", "life"),
    _route("POST", "/api/v1/v3/life/capability/patch/propose", "life", timeout_seconds=240),
    _route("POST", "/api/v1/v3/life/capability/patch/verify", "life", timeout_seconds=240),
