...
class WorldUnderstandingFacade:
    ...
    def __init__(self,*,enabled:bool=False,compiler_registry:CompilerRegistry|None=None,context_request_handler:Callable[[WorldIngressEnvelope],_ContextDisposition]|None=None)->None:
        ...
        if not self._enabled:
            ...
            self._ingress=WorldUnderstandingIngress(compiler_registry,context_request_handler=context_request_handler)
