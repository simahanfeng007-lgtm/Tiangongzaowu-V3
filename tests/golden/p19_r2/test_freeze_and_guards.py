...
- the single Verification Plane version source exists and is "1.49"
...
class ArchitectureGuardTests(unittest.TestCase):
    ...
    def test_single_verification_plane_version_source(self) -> None:
        ...
        self.assertEqual(VERIFICATION_PLANE_VERSION, "1.49")
...
class VerificationPlaneFreezeGuardTests(unittest.TestCase):
    ...
    AUTHORITY_SURFACE_FILES = (
        ...
        # R1F experience bridge and R1G-prep evaluation authority.
        "src/world_understanding/capability_composition/composition_experience_bridge.py",
        "src/world_understanding/capability_composition/formal_shadow.py",
        # P15-A tool-source publication into the one invalidation chain.
        "src/world_understanding/tool_capability_world/publication.py",
        # P12 admission materialization (the R1D provider gap).
        "src/total_gateway/composition_admission_materialization.py",
        # R1C3 plan-result admission intake; prior members remain covered.
        "src/total_gateway/composition_registration_intake.py",
        ...
        "src/life_service/legacy_learning_migration.py",
        ...
        "app/backend/tiangong-backend/v3/legacy_learning_telemetry.py",
        ...
        "src/total_gateway/learning_experience_writeback.py",
        ...
        "src/world_understanding/capability_composition/capability_experience_policy.py",
        "src/world_understanding/capability_composition/capability_experience_attribution.py",
        ...
        "src/total_gateway/method_source_publication.py",
        "src/total_gateway/method_source_review.py",
        "src/world_understanding/production.py",
        "src/world_understanding/world_state/store.py",
        "src/world_understanding/world_state/retention.py",
        "src/world_understanding/skill_method_world/publication.py",
        "src/world_understanding/skill_method_world/compiler.py",
        "src/world_understanding/skill_method_world/models.py",
        "src/world_understanding/skill_method_world/lifecycle.py",
        "app/backend/tiangong-backend/v3/world_understanding_production.py",
        ...
        "app/backend/tiangong-backend/v3/jineng/model_transport_anthropic.py",
        "app/backend/tiangong-backend/v3/jineng/model_transport_openai_responses.py",
        "app/backend/tiangong-backend/v3/jineng/model_transport_openai_chat.py",
        "app/backend/tiangong-backend/v3/jineng/model_transport_contract.py",
        "app/backend/tiangong-backend/v3/jineng/model_transport_executor.py",
        "app/backend/tiangong-backend/v3/jineng/model_context_cache.py",
