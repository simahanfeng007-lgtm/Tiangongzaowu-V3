...
- the single Verification Plane version source exists and is "1.23"
...
class ArchitectureGuardTests(unittest.TestCase):
    ...
    def test_single_verification_plane_version_source(self) -> None:
        ...
        self.assertEqual(VERIFICATION_PLANE_VERSION, "1.23")
...
class VerificationPlaneFreezeGuardTests(unittest.TestCase):
    def _freeze_manifest(self) -> dict:
        ...
        return {
            ...
            # Every 1.23 execution, result-schema and verification authority
    ...
    #: The authority surface frozen at 1.23; all inherited 1.10 and earlier entries remain covered.
