...
def test_p7b2_explicitly_advances_store_and_p19_compatibility() -> None:
    ...
    # materialization and the experience-recall seam extend it at 1.23; the batch-A deep-audit fixes extend it at 1.24; the R1H logical retirement extends it at 1.25; the P13-D deletion of capability_lifecycle removes it at 1.26.
    assert VERIFICATION_PLANE_VERSION == "1.26"
